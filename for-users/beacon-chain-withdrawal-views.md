...
Validator withdrawals will soon be activated on the Ethereum mainnet with the Shanghai/Capella hardfork ([EIP-4895](https://eips.ethereum.org/EIPS/eip-4895))**,** and UCHAIN.INFO will provide views for partial and full withdrawals.
...
The unique `index`, assigned `validatorIndex`, withdrawal receiving `address`, and `amount` are all included in the withdrawals structure and will be displayed on UCHAIN.INFO on the block and addresses pages.
...
_(Note, UCHAIN.INFO 1.0 mockups shown, the UCHAIN.INFO redesign will have a much improved UI)_
