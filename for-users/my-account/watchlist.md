...
1\) **Login to My Account in UCHAIN.INFO** <[_login instructions_](./)> . From the Watchlist menu click Add address.
...
* **Private tag**: For your reference, will be displayed as a private tag for your UCHAIN.INFO instance when you are logged in (emoji's accepted 🙂)
...
4\) Click the address to view in the UCHAIN.INFO console. Watch list addresses show the private tag when logged into My Account.
