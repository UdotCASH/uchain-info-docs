...
uchaininfo is setup to export [Prometheus](https://prometheus.io/) metrics at `/metrics`.
...
5. Add the dashboards from [https://github.com/deadtrickster/beam-dashboards](https://github.com/deadtrickster/beam-dashboards): For each `*.json` file in the repo.
   ...
   3. Click "Load"
6. View the dashboards. (You will need to click-around and use uchaininfo for the web-related metrics to show up.)
