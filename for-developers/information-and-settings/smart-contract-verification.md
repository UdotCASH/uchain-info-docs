...
* Application: [https://github.com/UdotCASH/uchain-info/-rs/tree/main/smart-contract-verifier](https://github.com/UdotCASH/uchain-info/-rs/tree/main/smart-contract-verifier)
* Http API: [https://github.com/UdotCASH/uchain-info/-rs/blob/main/smart-contract-verifier/smart-contract-verifier-http](https://github.com/UdotCASH/uchain-info/-rs/blob/main/smart-contract-verifier/smart-contract-verifier-http/README.md)
* Latest release information and changelogs:  [https://github.com/UdotCASH/uchain-info/-rs/releases](https://github.com/UdotCASH/uchain-info/-rs/releases)

### **Activation**

* Update UCHAIN.INFO to the 4.1.8+ release
* Add the following ENV variables:
  * `MICROSERVICE_SC_VERIFIER_ENABLED=true`
  * `MICROSERVICE_SC_VERIFIER_URL=...`  (verifier endpoint, see [http configuration](https://github.com/UdotCASH/uchain-info/-rs/tree/main/smart-contract-verifier/smart-contract-verifier-http) for more details)
* If running locally, the smart-contract-verifier is integrated with [`docker-compose`](https://github.com/UdotCASH/uchain-info//tree/master/docker-compose)``
  * Registry of docker images is available via the docker-compose file. For registry information see: [https://github.com/UdotCASH/uchain-info/-rs/pkgs/container/smart-contract-verifier](https://github.com/UdotCASH/uchain-info/-rs/pkgs/container/smart-contract-verifier)
...
* **Scalability**: Remove CPU intensive tasks from the primary UCHAIN.INFO instance. Modularity provides the ability to scale quickly.
...
On startup, the library must retrieve all available compilers. Compiler information consists of a link to download the compiler and its hashsum \[[example](https://github.com/UdotCASH/uchain-info/solc-bin/blob/main/list.json)]. A separate thread also starts during initialization to update this list periodically.&#x20;
...
Currently, verification requests are sent via HTTP requests. This module runs an HTTP server and provides endpoints through which external services (main UCHAIN.INFO instance, in our case) send verification requests and receive responses. Endpoints provided by the service and configuration details are described in the [corresponding Readme file](https://github.com/UdotCASH/uchain-info/-rs/tree/main/smart-contract-verifier-http).&#x20;
